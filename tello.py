...
class Tello:
    ...
    def send_command(self, command):
        ...
        print("utf encoded command")
        print(command.encode('utf-8'))
        print("normal encoded command")
    ...
    def get_height(self):
        ...
        # print("height received after sendinf height?")
        # print(height)
        height = str(height)
        # print("height after converting to string")
        # print(height)
        height = re.findall('-?\d+', height)[0]
        # height = ''.join(list(filter(str.isdigit, height)))
        # print("height after filter")
        # print(height)
        ...
        try:
            ...
            print("exception occured in height")
            print(e)
